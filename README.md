...
- **本次改动与安装说明**：[1.9.1](docs/RELEASE-1.9.1.md)。
...
`npm test` 目前包含 56 项本地数据、后台、数据库与帮助交互检查。界面通过本地预览检查；这不等于所有视频网站、Google 登录、线上云同步或 Notion 导出均通过实际扩展验收。当前没有在此仓库声明未核实的用户规模或线上效果。
